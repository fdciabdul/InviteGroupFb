...
<script>
    function exec() {
        $('#exec').addClass('btn btn-info').html('<i class="fa fa-spinner fa-spin" style="font-size:12px"></i> Đang xử lí..').attr('disabled', 'disabled');
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <input type="number" name="group" id="group" class="form-control" placeholder="Nhập ID Group cần mời thêm bạn bè là thành viên" />
            </div>
